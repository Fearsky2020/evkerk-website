...
form.addEventListener('submit',async e=>{
  ...
  try{await call('/api/human-auth/login',{identifier:id,password});bypass=true;secret.value='session';form.requestSubmit()}catch(err){setMessage(err.message,'error')}
},true);
