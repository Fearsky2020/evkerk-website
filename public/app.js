(() => {
  const translations = {
    zh: {
      ...
      'hero.eyebrow':'DEN HAAG · RIJSWIJK · ZOETERMEER','hero.title':'在恩典中认识耶稣，\n在真理里活出自由。','hero.lead':'无论你刚开始认识信仰，还是正在寻找一个属灵的家，都欢迎你来到福音教会。','hero.primary':'查看本周聚会','hero.secondary':'第一次来？','hero.photo.title':'欢迎来到福音教会','hero.photo':'每周日，我们在 Rijswijk 与 Zoetermeer 相聚',
    ...
    nl: {
      ...
      'hero.eyebrow':'DEN HAAG · RIJSWIJK · ZOETERMEER','hero.title':'Jezus leren kennen in genade,\nleven in vrijheid door de waarheid.','hero.lead':'Of je het christelijk geloof net ontdekt of op zoek bent naar een geestelijk thuis: je bent van harte welkom bij Evangeliekerk.','hero.primary':'Bekijk de zondag','hero.secondary':'Eerste keer?','hero.photo.title':'Welkom bij Evangeliekerk','hero.photo':'Elke zondag komen we samen in Rijswijk en Zoetermeer',
