(() => {
  const translations = {
    zh: {
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'咖啡会友小组：下班以后，来认识附近的新朋友。','groups.text':'咖啡会友小组是一个轻松认识新朋友的晚间聚会，不需要报名，也没有参加门槛。中文小组基本每天在不同地点开放，全部提供茶水和小点心，部分供应晚饭；通常18:30开始，21:00前结束。荷兰文小组时间另行公布。','groups.button':'帮我找到附近的咖啡会友小组','groups.coverage':'咖啡会友小组覆盖范围','groups.fact.days':'基本每天','groups.fact.time':'通常 18:30–21:00','groups.fact.snacks':'茶水与小点心','groups.fact.dinner':'部分供应晚饭','groups.mapnote':'标记为大致服务范围，具体聚会地点请联系教会',
