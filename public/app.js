(() => {
  const translations = {
    zh: {
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'一杯咖啡，一顿饭，认识附近的新朋友。','groups.text':'中文咖啡会友小组基本每天都在不同地点开放，适合轻松聊天、认识新朋友。所有小组提供茶水和小点心，部分小组也供应晚饭；通常18:30开始，21:00前结束。荷兰文小组的时间另行公布。地图只显示大致范围，不公开家庭地址。','groups.button':'帮我找到附近的咖啡会友小组','groups.mapnote':'标记为大致服务范围，具体聚会地点请联系教会',
