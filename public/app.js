(() => {
  const translations = {
    zh: {
      'brand.cn':'基督教福音教会','brand.subtitle':'EVANGELIEKERK','nav.gatherings':'聚会','nav.activities':'近期活动','nav.welcome':'第一次来','nav.sermons':'讲道','nav.ministries':'咖啡会友小组','nav.about':'关于我们','nav.visit':'在寻找教会吗？','nav.menu':'菜单',
    ...
    nl: {
      'brand.cn':'Evangeliekerk','brand.subtitle':'基督教福音教会','nav.gatherings':'Samenkomsten','nav.activities':'Activiteiten','nav.welcome':'Eerste keer','nav.sermons':'Preken','nav.ministries':'Koffie & ontmoeting','nav.about':'Over ons','nav.visit':'Op zoek naar een kerk?','nav.menu':'Menu',
