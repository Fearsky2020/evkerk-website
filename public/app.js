(() => {
  const translations = {
    zh: {
      ...
      'contact.eyebrow':'CONTACT US','contact.title':'想了解更多？给我们留言。','contact.text':'有关聚会、咖啡会友小组或第一次来教会的问题，都可以直接告诉我们。我们会通过你留下的联系方式回复。','contact.button':'查看聚会地点 →','contact.form.name':'怎么称呼你？','contact.form.contact':'怎样联系你？','contact.form.contactPlaceholder':'邮箱、电话或 WhatsApp','contact.form.message':'想了解什么？','contact.form.messagePlaceholder':'例如：第一次来、聚会时间、咖啡会友小组、儿童主日学……','contact.form.submit':'发送留言','contact.form.note':'提交后，我们会尽快通过你留下的联系方式回复。'
    },
    nl: {
