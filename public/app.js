(() => {
  const translations = {
    zh: {
      ...
      'sermons.eyebrow':'LATEST MESSAGE','sermons.title':'最新讲道','sermons.text':'错过了主日？在这里重温圣经信息，与我们一起在真理中成长。','sermons.all':'查看全部讲道 →','sermons.placeholder.label':'主日信息','sermons.placeholder.title':'最新讲道正在整理','sermons.placeholder.text':'欢迎先来参加本周主日聚会。',
