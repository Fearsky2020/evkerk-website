(() => {
  const translations = {
    zh: {
      'brand.header':'基督教福音教会','brand.cn':'基督教福音教会','brand.subtitle':'EVANGELIEKERK','nav.gatherings':'聚会','nav.activities':'近期活动','nav.welcome':'第一次来','nav.sermons':'讲道','nav.bible':'读经','nav.ministries':'咖啡会友小组','nav.about':'关于我们','nav.visit':'在寻找教会吗？','nav.menu':'菜单',
      ...
      'gatherings.eyebrow':'SUNDAY GATHERINGS','gatherings.title':'这个星期天，欢迎回家。','gatherings.text':'两个聚会地点，都欢迎第一次来的朋友。主日若有临时调整，将在网站首页更新。','gatherings.dh.label':'海牙 / Rijswijk','gatherings.dh.sep6':'9月6日 Rijswijk 暂停聚会；联合崇拜暨洗礼请前往 Zoetermeer（10:00）','gatherings.dh.title':'海牙基督教福音教会','gatherings.dh.meta':'每周日 · 中文崇拜 · 敬拜、讲道、圣餐、主日学','gatherings.zm.title':'主特美基督教福音教会','gatherings.zm.meta':'每周日上午 · 中文崇拜与荷兰文崇拜 · 敬拜、讲道、圣餐、主日学','gatherings.map':'打开地图 →','schedule.monday':'每周一','schedule.saturday':'每周六','schedule.sunday':'每周日','schedule.serviceCourse':'服事小组课程','schedule.sundayService':'主日聚会','schedule.bilingualService':'中文及荷兰文主日聚会','schedule.sundaySchool':'主日学','schedule.bibleStudy':'查经班',
      'welcome.eyebrow':'FIRST TIME HERE?','welcome.title':'第一次来，不需要准备什么。','welcome.text':'你可以安静听信息、一起敬拜，也可以只是先认识这里。无需报名，也不会有人要求你一定做什么。','welcome.1.title':'有人欢迎你','welcome.1.text':'接待同工会帮助你找到座位、儿童主日学或合适的语言聚会。','welcome.2.title':'敬拜与信息','welcome.2.text':'用诗歌、祷告和圣经信息，一起认识神的恩典。','welcome.3.title':'留下来聊一会儿','welcome.3.text':'聚会后通常有交通时间，可以认识弟兄姊妹，也可以请同工为你祷告。','faq.eyebrow':'GOOD TO KNOW','faq.title':'第一次来，常见问题','faq.signup.q':'需要提前报名吗？','faq.signup.a':'不需要。你可以直接来参加主日聚会。','faq.clothes.q':'需要穿得很正式吗？','faq.clothes.a':'不需要，穿平时舒服、合适的衣服就可以。','faq.children.q':'可以带孩子来吗？','faq.children.a':'可以。到达后请向接待同工询问适合孩子的安排。','faq.pressure.q':'只是想先看看，可以吗？','faq.pressure.a':'当然可以。你可以安静参加，不需要作任何承诺。','footer.privacy':'隐私声明',
      'activities.eyebrow':'RECENT LIFE','activities.title':'教会最近在发生什么？','activities.text':'教会活动、团契活动和小组生活都会在这里更新。照片会自动轮播，点击左右箭头也能查看。','activities.all':'查看全部活动 →','activities.churchlife':'教会生活','activities.gathering':'主日聚会','activities.zoetermeer.title':'Zoetermeer 福音教会','activities.zoetermeer.meta':'Piet Heinplein 13 · Zoetermeer','activities.sanctuary.title':'一起敬拜、聆听与相遇','activities.sanctuary.meta':'每周日 10:00–12:00 · Zoetermeer',
      'sermons.eyebrow':'LATEST MESSAGE','sermons.title':'最新讲道','sermons.text':'错过了主日？在这里重温圣经信息，与我们一起在真理中成长。','sermons.all':'查看全部讲道 →','sermons.placeholder.label':'主日信息','sermons.placeholder.title':'最新讲道正在整理','sermons.placeholder.text':'欢迎先来参加本周主日聚会。','sermons.summary.label':'信息摘要','sermons.summary.empty':'后台填写讲道摘要后，会自动显示在这里。',
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'咖啡会友小组：下班以后，来认识附近的新朋友。','groups.text':'咖啡会友小组是一个轻松认识新朋友的晚间聚会，不需要报名，也没有参加门槛。中文小组基本每天在不同地点开放，全部提供茶水和小点心，部分供应晚饭；通常18:30开始，21:00前结束。荷兰文小组每周四18:30–21:30聚会。','groups.button':'帮我找到附近的咖啡会友小组','groups.coverage':'咖啡会友小组覆盖范围','groups.fact.days':'基本每天','groups.fact.time':'通常 18:30–21:00','groups.fact.snacks':'茶水与小点心','groups.fact.dinner':'部分供应晚饭','groups.fact.dutch':'荷兰文小组：周四 18:30–21:30','groups.mapnote':'标记为大致范围，具体聚会地点和时间请与我们联系',
    ...
    nl: {
      'brand.header':'Evangeliekerk','brand.cn':'Evangeliekerk','brand.subtitle':'基督教福音教会','nav.gatherings':'Samenkomsten','nav.activities':'Activiteiten','nav.welcome':'Eerste keer','nav.sermons':'Preken','nav.bible':'Bijbel','nav.ministries':'Koffie & ontmoeting','nav.about':'Over ons','nav.visit':'Op zoek naar een kerk?','nav.menu':'Menu',
      ...
      'welcome.eyebrow':'FIRST TIME HERE?','welcome.title':'Voor je eerste bezoek hoef je niets voor te bereiden.','welcome.text':'Je mag rustig luisteren, meezingen of gewoon eerst kennismaken. Aanmelden is niet nodig en er wordt niets van je verwacht.','welcome.1.title':'Je wordt welkom geheten','welcome.1.text':'Ons ontvangstteam helpt je met een plek, de zondagsschool of de passende taalgroep.','welcome.2.title':'Aanbidding & boodschap','welcome.2.text':'Met liederen, gebed en de Bijbel leren we samen Gods genade kennen.','welcome.3.title':'Blijf gerust even','welcome.3.text':'Na de dienst is er tijd voor ontmoeting, gesprek en persoonlijk gebed.','faq.eyebrow':'GOED OM TE WETEN','faq.title':'Veelgestelde vragen voor je eerste bezoek','faq.signup.q':'Moet ik mij vooraf aanmelden?','faq.signup.a':'Nee. Je kunt gewoon naar een zondagsdienst komen.','faq.clothes.q':'Moet ik mij netjes aankleden?','faq.clothes.a':'Nee. Draag gerust gewone kleding waarin je je prettig voelt.','faq.children.q':'Kan ik kinderen meenemen?','faq.children.a':'Ja. Vraag bij aankomst aan het ontvangstteam naar de mogelijkheden voor kinderen.','faq.pressure.q':'Mag ik ook gewoon eerst komen kijken?','faq.pressure.a':'Natuurlijk. Je mag rustig deelnemen, zonder enige verplichting.','footer.privacy':'Privacy',
      'activities.eyebrow':'RECENT LIFE','activities.title':'Wat gebeurt er in onze gemeente?','activities.text':'Gemeenteactiviteiten, fellowship en kringleven verschijnen hier. De foto’s wisselen automatisch; je kunt ook de pijlen gebruiken.','activities.all':'Bekijk alle activiteiten →','activities.churchlife':'Gemeenteleven','activities.gathering':'Zondagse dienst','activities.zoetermeer.title':'Evangeliekerk Zoetermeer','activities.zoetermeer.meta':'Piet Heinplein 13 · Zoetermeer','activities.sanctuary.title':'Samen aanbidden, luisteren en ontmoeten','activities.sanctuary.meta':'Elke zondag 10:00–12:00 · Zoetermeer',
      'sermons.eyebrow':'LATEST MESSAGE','sermons.title':'Laatste preek','sermons.text':'Een zondag gemist? Luister hier naar de Bijbelse boodschap en groei met ons mee.','sermons.all':'Bekijk alle preken →','sermons.placeholder.label':'Zondagsboodschap','sermons.placeholder.title':'De nieuwste preek wordt voorbereid','sermons.placeholder.text':'Je bent alvast van harte welkom bij de dienst van deze zondag.','sermons.summary.label':'KORTE SAMENVATTING','sermons.summary.empty':'De samenvatting uit het beheer verschijnt hier automatisch.',
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'Koffie & ontmoeting: kom na je dag nieuwe mensen uit de buurt leren kennen.','groups.text':'Een laagdrempelige avond om ontspannen nieuwe mensen te ontmoeten; aanmelden is niet nodig. Bijna elke dag is er op een andere plek een Chineestalige groep, altijd met koffie, thee en iets lekkers en soms met avondeten. Meestal van 18:30 tot vóór 21:00. De Nederlandstalige groep komt elke donderdag van 18:30 tot 21:30 samen.','groups.button':'Vind een koffiegroep bij mij in de buurt','groups.coverage':'Gebieden met koffie- en ontmoetingsgroepen','groups.fact.days':'Bijna elke dag','groups.fact.time':'Meestal 18:30–21:00','groups.fact.snacks':'Koffie, thee en iets lekkers','groups.fact.dinner':'Soms met avondmaaltijd','groups.fact.dutch':'Nederlandstalige groep: donderdag 18:30–21:30','groups.mapnote':'De markeringen tonen globale gebieden; neem contact met ons op voor de exacte locatie en tijd',
      ...
      'contact.eyebrow':'CONTACT US','contact.title':'Meer weten? Stuur ons een bericht.','contact.text':'Vragen over een samenkomst, een koffie- en ontmoetingsgroep of je eerste bezoek? Laat het ons gerust weten. We nemen contact met je op via de gegevens die je achterlaat.','contact.button':'Bekijk locaties →','contact.form.name':'Hoe mogen we je noemen?','contact.form.contact':'Hoe kunnen we je bereiken?','contact.form.contactPlaceholder':'E-mail, telefoon of WhatsApp','contact.form.message':'Waar wil je meer over weten?','contact.form.messagePlaceholder':'Bijvoorbeeld: eerste bezoek, tijden, koffiegroep of zondagsschool…','contact.form.submit':'Verstuur bericht','contact.form.sending':'Bezig met versturen…','contact.form.success':'Je bericht is verzonden. We nemen zo snel mogelijk contact op.','contact.form.error':'Versturen is mislukt. Probeer het later opnieuw.','contact.form.note':'We reageren zo snel mogelijk via de contactgegevens die je achterlaat.'
    }
  };
  ...
  if (contactForm && contactStatus) {
    contactForm.addEventListener('submit', async (event) => {
      ...
      contactStatus.textContent = dict['contact.form.sending'];
      try {
        ...
        contactStatus.textContent = dict['contact.form.error'];
      } finally {
