(() => {
  const translations = {
    zh: {
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'一杯咖啡，一顿饭，认识附近的新朋友。','groups.text':'咖啡会友小组分布在海牙及周边，轻松聊天、认识新朋友，部分小组也会预备晚饭。聚会通常18:30开始，21:00前结束。地图只显示大致范围，不公开家庭地址。','groups.button':'帮我找到附近的咖啡会友小组','groups.mapnote':'标记为大致服务范围，具体聚会地点请联系教会',
