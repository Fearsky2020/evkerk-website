(() => {
  const translations = {
    zh: {
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'一杯咖啡，一顿饭，认识附近的新朋友。','groups.text':'咖啡会友小组基本每天都在不同地点开放，适合轻松聊天、认识新朋友。所有小组提供茶水和小点心，部分小组也供应晚饭；聚会通常18:30开始，21:00前结束。地图只显示大致范围，不公开家庭地址。','groups.button':'帮我找到附近的咖啡会友小组','groups.mapnote':'标记为大致服务范围，具体聚会地点请联系教会',
    ...
    nl: {
      ...
      'groups.eyebrow':'COFFEE & CONNECTION NEAR YOU','groups.title':'Koffie, eten en nieuwe mensen bij jou in de buurt.','groups.text':'Bijna elke dag is er op een andere plek in Den Haag en omgeving een koffie- en ontmoetingsgroep. Een ontspannen avond om mensen te leren kennen. Elke groep biedt koffie, thee en iets lekkers; sommige groepen verzorgen ook een avondmaaltijd. Meestal beginnen we om 18:30 en ronden we vóór 21:00 af. De kaart toont alleen globale gebieden, nooit huisadressen.','groups.button':'Vind een koffiegroep bij mij in de buurt','groups.mapnote':'De markeringen tonen globale gebieden; neem contact op voor de ontmoetingsplek',
