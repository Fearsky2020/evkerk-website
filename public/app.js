(() => {
  const translations = {
    zh: {
      ...
      'groups.eyebrow':'SMALL GROUPS NEAR YOU','groups.title':'在你生活的地方，一起信仰、一起成长。','groups.text':'我们在海牙及周边设有不同的小组。地图只显示大致范围，不公开家庭地址；联系我们后，我们会按你的居住区域介绍合适的小组。','groups.button':'帮我找到附近的小组','groups.mapnote':'标记为大致服务范围，具体聚会地点请联系教会',
    ...
    nl: {
      ...
      'groups.eyebrow':'SMALL GROUPS NEAR YOU','groups.title':'Samen geloven en groeien, dicht bij huis.','groups.text':'Onze kringen komen samen in Den Haag en omgeving. De kaart toont alleen globale gebieden, nooit huisadressen. Neem contact op en wij helpen je een passende kring in de buurt te vinden.','groups.button':'Vind een kring bij mij in de buurt','groups.mapnote':'De markeringen tonen globale gebieden; neem contact op voor de ontmoetingsplek',
