(() => {
  const translations = {
    zh: {
      'brand.cn':'福音教会','nav.gatherings':'聚会','nav.activities':'近期活动','nav.welcome':'第一次来','nav.sermons':'讲道','nav.ministries':'小组与事工','nav.about':'关于我们','nav.visit':'来参加聚会',
      ...
      'gatherings.eyebrow':'SUNDAY GATHERINGS','gatherings.title':'这个星期天，欢迎回家。','gatherings.text':'两个聚会地点，都欢迎第一次来的朋友。主日若有临时调整，将在网站首页更新。','gatherings.dh.label':'海牙 / Rijswijk','gatherings.dh.sep6':'9月6日 Rijswijk 暂停聚会；联合崇拜暨洗礼请前往 Zoetermeer（10:00）','gatherings.dh.title':'海牙基督教福音教会','gatherings.dh.meta':'每周日 · 中文与荷兰文 · 敬拜、讲道、圣餐、主日学','gatherings.zm.title':'Zoetermeer 基督教福音教会','gatherings.zm.meta':'每周日 · 中文与荷兰文 · 敬拜、讲道、圣餐、主日学','gatherings.map':'打开地图 →','schedule.monday':'每周一','schedule.saturday':'每周六','schedule.sunday':'每周日','schedule.serviceCourse':'服事小组课程','schedule.sundaySchool':'主日学','schedule.bibleStudy':'查经班',
    ...
    nl: {
      'brand.cn':'Evangeliekerk','nav.gatherings':'Samenkomsten','nav.activities':'Activiteiten','nav.welcome':'Eerste keer','nav.sermons':'Preken','nav.ministries':'Kringen & bediening','nav.about':'Over ons','nav.visit':'Bezoek een dienst',
