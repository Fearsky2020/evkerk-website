(() => {
  const translations = {
    zh: {
      ...
      'gatherings.eyebrow':'SUNDAY GATHERINGS','gatherings.title':'这个星期天，欢迎回家。','gatherings.text':'两个聚会地点，都欢迎第一次来的朋友。主日若有临时调整，将在网站首页更新。','gatherings.dh.label':'海牙 / Rijswijk','gatherings.dh.sep6':'9月6日 Rijswijk 暂停聚会；联合崇拜暨洗礼请前往 Zoetermeer（10:00）','gatherings.dh.title':'海牙基督教福音教会','gatherings.dh.meta':'每周日 · 中文与荷兰文 · 敬拜、讲道、圣餐、主日学','gatherings.zm.title':'Zoetermeer 基督教福音教会','gatherings.zm.meta':'每周日 · 中文与荷兰文 · 敬拜、讲道、圣餐、主日学','gatherings.map':'打开地图 →',
