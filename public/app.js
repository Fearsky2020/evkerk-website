(() => {
  const translations = {
    zh: {
      'brand.header':'基督教福音教会','brand.cn':'基督教福音教会','brand.subtitle':'EVANGELIEKERK','nav.gatherings':'聚会','nav.activities':'近期活动','nav.welcome':'第一次来','nav.sermons':'讲道','nav.bible':'圣经','nav.ministries':'咖啡会友小组','nav.about':'关于我们','nav.visit':'在寻找教会吗？','nav.menu':'菜单',
